{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/fsarfraz/workspaces/robo_ws";
  project_input_ref = "path:/home/fsarfraz/workspaces/robo_ws";
  devenv_dotfile = "/home/fsarfraz/workspaces/robo_ws/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-172b931";
  devenv_istesting = false;
  devenv_direnvrc_latest_version = 1;
  container_name = null;
  active_profiles = [
  ];
  hostname = "fsarfraz-Precision-5690";
  username = "fsarfraz";
  git_root = "/home/fsarfraz/workspaces/robo_ws";
  secretspec = null;
};
    in
    {
